...
public class EvaluationFormViewModel
{
    ...
    /// <summary>Scoring method: 0 = Generic (proportional), 1 = SectionAutoFail.</summary>
...
public class AnalyticsViewModel
{
    ...
    public List<SectionScoreViewModel> SectionScores { get; set; } = new();
}
...
public class TniSummaryViewModel
{
    public int TotalPlans { get; set; }
    public int OpenPlans { get; set; }
    public int CompletedPlans { get; set; }
    public int OverduePlans { get; set; }
    public List<TniStatusCountViewModel> ByStatus { get; set; } = new();
    public List<TniAgentSummaryViewModel> ByAgent { get; set; } = new();
    public List<TniRecentPlanViewModel> RecentPlans { get; set; } = new();
}

public class TniStatusCountViewModel
{
    public string Status { get; set; } = string.Empty;
    public int Count { get; set; }
}

public class TniAgentSummaryViewModel
{
    public string AgentName { get; set; } = string.Empty;
    public int TotalPlans { get; set; }
    public int OpenPlans { get; set; }
...
public class TniRecentPlanViewModel
{
    public int Id { get; set; }
    public string Title { get; set; } = string.Empty;
    public string AgentName { get; set; } = string.Empty;
